...
router.post('/register', async(req, res)=>{
   ...
   if(!username || !password){res.status(401).json({message:'both username and password required'})
} else if(user){res.status(401).json({message:'The user name that you provided has been taken. Use different username!'})
} else{
